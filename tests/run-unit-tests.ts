        ...
        questions: [
          {
            ...
            interviewerIntent: "Check conceptual understanding",
            answerOpening: "Hooks let functional components use stateful logic.",
            answerFramework: ["Define hooks", "Explain common usage", "Give one example"],
            revisionChecklist: ["Know useState", "Know useEffect", "Avoid conditional hooks"],
        ...
        questions: [
          {
            ...
            interviewerIntent: "Bad intent",
            answerOpening: "Bad opening",
            answerFramework: ["Bad"],
            revisionChecklist: ["Bad"],
            example: "Bad example",
